const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-04-01', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '分享心得',
  HEO_HERO_TITLE_2: '与思维认知',
  HEO_HERO_TITLE_3: 'go.cs.vercel.app',
  HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: '全新网站，更好笔记',
  HEO_HERO_TITLE_LINK: 'https://go.cs.vercel.app',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '查看更多',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: 'ASM精选', url: '/tag/ASM' },
